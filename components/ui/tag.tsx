...
const tagVariants = cva(
  'inline-flex items-center rounded-[5px] px-1 py-[5px] text-base font-normal leading-4 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
